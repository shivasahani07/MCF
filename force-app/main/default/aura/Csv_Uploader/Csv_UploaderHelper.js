({
        ...
        if(!file.name.match(/\.(csv||CSV)$/)){
            ...
            reader.onload = function(e) {
                ...
                console.log("Rows length::"+dataRows);
                    ...
                    var lines = [];
                    var filecontentdata;
                    var content = "<table class=\"table slds-table slds-scrollable slds-table--bordered slds-table--cell-buffer\">";
                    ...
                    for (var i=1; i<allTextLines.length; i++) {
                        ...
                        if(filecontentdata[0]!=''){
                            ...
                            for(var j=0;j<filecontentdata.length;j++){
                                content +='<td class="slds-truncate slds-cell-wrap">'+filecontentdata[j]+'</td>';
                            }
                            content +="</tr>";
                        }
                    }
    ...
    saveRecords : function(component,event){
        ...
        action.setParams({ fileData : component.get("v.fileContentData"),
                          sobjectName:'Resource_Schedule_Item__c', //Any object
                          fields:fieldsList,
