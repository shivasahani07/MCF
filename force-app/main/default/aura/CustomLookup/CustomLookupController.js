({
    doInit: function(component, event, helper){
        debugger;
        var selectedUserRecId = component.get("v.selectRecordId");
        var action = component.get("c.getSelectedUserRecord");
        action.setParams({
            "ObjectName" : component.get("v.objectName"),
            "fieldName" : component.get("v.fieldName"),
            "userId" : selectedUserRecIdeval
        });
        ...
        action.setCallback(this, function(response){
            ...
            if(STATE === "SUCCESS") {
                var selectedUserrec = response.getReturnValue();
               component.set("v.selectRecordName", selectedUserrec.Name);
            }
            else if (state === "ERROR") {
