({
	doInit : function(component, event, helper) {
        ...
        var ThirdList=[{month:'January'+' '+year,colormatch:null},{month:'February'+' '+year,colormatch:null},{month:'March'+' '+year,colormatch:null},{month:'April'+' '+year,colormatch:null},{month:'May'+' '+year,colormatch:null} ,{month:'June'+' '+year,colormatch:null},{month:'July'+' '+year,colormatch:null},{month:'August'+' '+year,colormatch:null},{month:'September'+' '+year,colormatch:null},{month:'October'+' '+year,colormatch:null},{month:'November'+' '+year,colormatch:null},{month:'December'+' '+year,colormatch:null}];
        for(let i=0;i<ThirdList.length; i++){
            if(ThirdList[i].month==MonthName){
                console.log('ThirdList');
                component.set("v.MonthListToShowMobile",ThirdList); 
            }else{
                ThirdList[i].colormatch = false;
            }
        }
