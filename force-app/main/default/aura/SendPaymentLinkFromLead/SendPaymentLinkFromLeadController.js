    ...
    doInit: function(component, event) {
        ...
        action.setCallback(this, function(response) {
            ...
            if (response.getState() === "SUCCESS") {
                ...
                if (serverresponse.Course_Fees__c <= 0 || serverresponse.Course_Fees__c == undefined) {
                    var toastEvent = $A.get("e.force:showToast");
                    toastEvent.setParams({
                        title: 'Warning',
                        message: 'Provide Vocal course Fees',
                        duration: ' 5000',
                        key: 'info_alt',
                        type: 'warning',
                        mode: 'sticky'
                ...
                if(serverresponse.Course_Fees__c > 0 && serverresponse.Email != null && serverresponse.Phone != null){
                    var toastEvent = $A.get("e.force:showToast");
                    toastEvent.setParams({
                        title: 'Success',
