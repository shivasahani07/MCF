    ...
    doInit: function(component, event) {
        ...
        action.setCallback(this, function(response) {
            ...
            if (response.getState() === "SUCCESS") {
                ...
                if (serverresponse.Amount == undefined || serverresponse.Account.Email__c == undefined || serverresponse.Account.Phone == undefined) {
                    if(serverresponse.Amount == undefined ){
                    ...
                    if(serverresponse.Account.Email__c == undefined ){
                        var toastEvent = $A.get("e.force:showToast");
                        toastEvent.setParams({
                            title: 'Warning',
                            message: 'Please update Email on Account',
                            duration: ' 5000',
                            key: 'info_alt',
                            type: 'warning',
                            mode: 'sticky'
                    ...
                    if(serverresponse.Account.Phone == undefined ){
                        
                        var toastEvent = $A.get("e.force:showToast");
                        toastEvent.setParams({
                            title: 'Warning',
                            message: 'Please update Phone on Account',
                            duration: ' 5000',
                            key: 'info_alt',
                            type: 'warning',
                            mode: 'sticky'
