...
export default class NewsFeedCompNew extends LightningElement {
    @track recList = [];
    @api url = '';
    @wire(getRecordList,{})
    wiredResponse(result){
        if(result.data){
            ...
            for(let i =0; i<result.data.length; i++){
                ...
                rec.url = 'https://sales-production--fsldemo.sandbox.lightning.force.com/lightning/r/News_Feed__c/'+rec.Id+'/view';
                this.recList[i] = rec;
