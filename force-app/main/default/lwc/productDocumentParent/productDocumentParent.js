...
import getFoldersAndFiles from '@salesforce/apex/ProductDocumentLWCController.getFoldersAndFiles';
import getSubFoldersAndFiles from '@salesforce/apex/ProductDocumentLWCController.getSubFoldersAndFiles';
import createFolderSP from '@salesforce/apex/ProductDocumentLWCController.createFolder';
import deleteFolderInsideSite from '@salesforce/apex/ProductDocumentLWCController.deleteFolderInsideSite';
import deleteFileSP from '@salesforce/apex/ProductDocumentLWCController.deleteFileSP';
import createFile from '@salesforce/apex/ProductDocumentLWCController.createFile';
import downloadFile from '@salesforce/apex/ProductDocumentLWCController.downloadFile';

import { refreshApex } from '@salesforce/apex';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';


export default class ProductDocumentParent extends LightningElement {
    @api recordId;
    ...
    fileClickedHandler(event){
        ...
        if(path && path.length>0){
            ...
            let path = 'https://utillabs.sharepoint.com/sites/FSLDEMO/Shared%20Documents/Forms/AllItems.aspx?id='+id+'&parent='+parent;
            window.open(path,'_blank');
        }
    }
