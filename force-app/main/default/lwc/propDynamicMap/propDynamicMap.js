...
export default class PropDynamicMap extends LightningElement {

    @api queryString =
    "SELECT Id, Name, Status__c, BillingLatitude, BillingLongitude FROM Account WHERE BillingLatitude != null AND Status__c = 'Proposal'";
